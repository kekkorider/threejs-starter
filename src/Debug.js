...
export class Debug {
  ...
  #createBoxConfig() {
    ...
    folder.addBinding(mesh.material, 'metalness', { label: 'Metallic', min: 0, max: 1 })
    folder.addBinding(mesh.material, 'roughness', { label: 'Roughness', min: 0, max: 1 })
  }
  ...
  #createShadedBoxConfig() {
    ...
    folder.addBinding(mesh.scale, 'x', { label: 'Width', min: 0.1, max: 4 })
    folder.addBinding(mesh.scale, 'y', { label: 'Height', min: 0.1, max: 4 })
    folder.addBinding(mesh.scale, 'z', { label: 'Depth', min: 0.1, max: 4 })
  }
  ...
  #createLightConfig() {
    ...
    folder.addBinding(this.app.pointLight, 'intensity', { label: 'Intensity', min: 0, max: 1000 })
  }
